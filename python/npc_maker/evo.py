...
class Recorder(Service):
    ...
    def get_best(self):
        ...
        best = Individual.load(path, controller=self.controller())
        return best
...
class Evolution(Service):
    ...
    def __init__(self, controller, seed, mutate=None, crossover=None, allow_mating=True,
        ...
        # 
        if   population_type == "generation":  PopClass = _Generation
        elif population_type == "continuous":  PopClass = _Continuous
        elif population_type == "best":        PopClass = _Best
